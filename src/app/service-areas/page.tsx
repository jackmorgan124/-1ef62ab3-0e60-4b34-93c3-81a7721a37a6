...
export const metadata: Metadata = {
  ...
  description:
    'Harris Landscaping & Gardens delivers premium outdoor transformations across South-West Sydney — Campbelltown, Camden, Narellan, Picton, and the Macarthur region.',
};
